...
function defineAlloyMode() {
    const keywords = `${paragraphKeywords}|one|lone|none|some|abstract|all|iff|but|else|extends|set|implies|module|open|and|disj|for|in|no|or|as|Int|String|sum|exactly|iden|let|not|univ|enum|var|Time|always|historically|eventually|once|after|before|until|since|releases|triggered`
